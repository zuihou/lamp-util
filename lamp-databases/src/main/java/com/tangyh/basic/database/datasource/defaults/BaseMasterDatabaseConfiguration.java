package com.tangyh.basic.database.datasource.defaults;
 ...
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"com.tangyh.basic"}) 修改为  @MapperScan(basePackages = {"com.tangyh.basic.product.dao"})
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.tangyh.basic"}, 修改为  basePackages = {"com.tangyh.basic.order.dao"} # 这个路径根据你的情况修改
 ...
 * <p>
 * 完成上述修改后， 位于com.tangyh.basic.product.dao 包下的dao 将操作  master 库， com.tangyh.basic.order.dao中的dao 将操作slave库
 *
 * @author zuihou
