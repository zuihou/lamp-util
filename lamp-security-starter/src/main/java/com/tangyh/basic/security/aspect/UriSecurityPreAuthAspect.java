package com.tangyh.basic.security.aspect;
...
public class UriSecurityPreAuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.tangyh.basic.base.controller.*.*(..)) || " +
            "@annotation(com.tangyh.basic.annotation.security.PreAuth) || " +
            "@within(com.tangyh.basic.annotation.security.PreAuth)"
    )
