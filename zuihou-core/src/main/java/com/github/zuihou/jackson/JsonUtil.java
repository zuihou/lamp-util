...
import static com.github.zuihou.utils.StrPool.LEFT_SQ_BRACKET;
import static com.github.zuihou.utils.StrPool.RIGHT_SQ_BRACKET;
...
public class JsonUtil {
    ...
    public static <T> List<T> parseArray(String content, Class<T> valueTypeRef) {
        try {
            if (!StrUtil.startWith(content, LEFT_SQ_BRACKET)) {
                content = new StringBuilder().append(LEFT_SQ_BRACKET).append(content).append(RIGHT_SQ_BRACKET).toString();
            }
