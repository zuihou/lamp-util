package com.tangyh.basic.log.aspect;
...
import com.tangyh.basic.context.ThreadLocalParam;
import com.tangyh.basic.jackson.JsonUtil;
import com.tangyh.basic.log.entity.OptLogDTO;
import com.tangyh.basic.log.event.SysLogEvent;
import com.tangyh.basic.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.tangyh.basic.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.tangyh.basic.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.tangyh.basic.annotation.log.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.tangyh.basic.base.controller.*.*(..)) || @annotation(com.tangyh.basic.annotation.log.SysLog)")
