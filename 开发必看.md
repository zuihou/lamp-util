...
mvn versions:set -DnewVersion=3.5.0 -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion=3.5.0-SNAPSHOT -DskipTests -DgenerateBackupPoms=false
