...
mvn versions:set -DnewVersion="3.8.1" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.8.1-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
