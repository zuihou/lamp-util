...
mvn versions:set -DnewVersion="3.6.1" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.6.1-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
