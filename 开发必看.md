...
mvn versions:set -DnewVersion=3.3.0 -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion=3.3.0-SNAPSHOT -DskipTests -DgenerateBackupPoms=false
