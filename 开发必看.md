...
mvn versions:set -DnewVersion="5.0.4" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.4-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
