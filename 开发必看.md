...
mvn versions:set -DnewVersion="5.3.1" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.3.1-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
