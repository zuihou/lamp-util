...
mvn versions:set -DnewVersion="5.0.6" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.6-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
