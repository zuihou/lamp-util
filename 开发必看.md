...
mvn versions:set -DnewVersion="5.0.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
