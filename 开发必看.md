...
mvn versions:set -DnewVersion="4.21.0-java17" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="4.21.0-java17-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
