...
mvn versions:set -DnewVersion="5.0.2" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.2-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
