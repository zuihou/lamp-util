...
mvn versions:set -DnewVersion="3.5.5" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.5.5-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
