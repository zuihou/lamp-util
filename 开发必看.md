...
mvn versions:set -DnewVersion="5.1.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.1.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
