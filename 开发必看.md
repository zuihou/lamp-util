...
mvn versions:set -DnewVersion=3.2.5 -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion=3.2.5-SNAPSHOT -DskipTests -DgenerateBackupPoms=false
