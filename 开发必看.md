...
mvn versions:set -DnewVersion="4.21.1-java17" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="4.21.1-java17-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
