...
mvn versions:set -DnewVersion="5.3.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.3.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
