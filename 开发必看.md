...
mvn versions:set -DnewVersion="3.7.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.7.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
