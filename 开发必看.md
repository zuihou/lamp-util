...
mvn versions:set -DnewVersion="3.8.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.8.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
