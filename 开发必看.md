...
mvn versions:set -DnewVersion="3.5.7" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.5.7-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
