开源版的 lamp-util 工具包所有模块的jar都已经发布到了Maven中央仓库，不需要二次开发的朋友可以忽略本项目，直接运行 [lamp-cloud](https://github.com/dromara/lamp-cloud) 和 [lamp-boot](https://github.com/zuihou111/lamp-boot).
...
mvn versions:set -DnewVersion="3.8.2" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.8.2-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
