...
mvn versions:set -DnewVersion="5.0.1" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.1-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
