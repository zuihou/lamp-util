...
mvn versions:set -DnewVersion=3.5.3 -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion=3.5.3-SNAPSHOT -DskipTests -DgenerateBackupPoms=false
