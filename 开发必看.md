...
mvn versions:set -DnewVersion="3.6.2" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.6.2-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
