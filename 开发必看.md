...
mvn versions:set -DnewVersion="3.6.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="3.6.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
