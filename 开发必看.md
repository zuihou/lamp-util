...
mvn versions:set -DnewVersion="5.0.3" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.0.3-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
